class StrainsController < ApplicationController
  ...
  def strain_params
    params.require(:strain).permit(:average_rating, :category, :flower_svg, :name, :nug_image, :phenotype, :review_count, :short_description, :slug, :top_terp, :subtitle, :thc, :top_effect, :distance)
  end
end
